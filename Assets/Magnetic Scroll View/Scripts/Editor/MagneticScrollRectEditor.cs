...
namespace MagneticScrollView
{
    ...
    {
        private SerializedProperty elements, viewport, scrollRect, indexTableManager, autoArranging, /*useButtons, useIndexTable,*/ alignment, layoutMode, curvature, inertia, decelerationRate, realtimeSelection, infiniteScrolling, smoothTransition, transitionCurve, invertOrder, useMargin, rotate, snapMode,
            resizeMode, elementsSize, globalOffset, elementPadding, scrollLimitGap, scrollAdditionalLimits, circularFactor, distanceOffset, transitionSpeed, dragDelay, backButton, forwardButton, indexTable, onSelectionChange, onSelectionChangeDelay, onScrolling;
        ...
        private void OnEnable ()
        {
            ...
            scrollLimitGap = serializedObject.FindProperty ("scrollLimitGap");
        ...
        private void ShowInspector ()
        {
            ...
            EditorGUILayout.PropertyField (scrollRect, new GUIContent ("Scroll Rect"));
            EditorGUIUtility.labelWidth += 50f;
            ...
            if (controlSettings)
            {
                ...
                {
                    EditorGUILayout.PropertyField (scrollLimitGap);
